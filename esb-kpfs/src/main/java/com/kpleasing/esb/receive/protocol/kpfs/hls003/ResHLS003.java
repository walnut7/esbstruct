...
public class ResHLS003 {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ResHLS003.class);
	...
	public static ResHLS003 fromXML(String xml) throws Exception {
		return (ResHLS003) BeanXMLMapping.fromXML(xml, ResHLS003.class);
	}
	...
	public String toResponseXML() throws KPFSBusinessException {
		try {
			...
			.append("<phone>").append(this.phone).append("</phone>")
