package com.kpleasing.esb.receive.protocol.kpfs.fs001;

public class ReqFS001 {
	...
	public String getReq_serial_date() {
		return req_date;
	}

	public void setReq_serial_date(String req_serial_date) {
		this.req_date = req_serial_date;
	}
