...
public class ResHLS004 {
	
private static final Logger LOGGER = LoggerFactory.getLogger(ResHLS004.class);
	...
	public static ResHLS004 fromXML(String xml) throws Exception {
		return (ResHLS004) BeanXMLMapping.fromXML(xml, ResHLS004.class);
	}
	...
	public String toResponseXML() throws KPFSBusinessException {
		try {
			...
			.append("<query_type>").append(this.query_type).append("</query_type>")
