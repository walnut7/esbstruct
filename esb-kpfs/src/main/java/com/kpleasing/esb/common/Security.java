...
public class Security {
	...
	public static boolean checkIsSignValidFromResponseString(String responseString, String key)
		...
		Map<String, Object> map = XMLHelper.getMapFromXML(responseString);
	...
	public static String getSign(Map<String, Object> map, String key) {
		...
		result = com.kpleasing.esb.common.MD5.MD5Encode(result).toUpperCase();
	...
	public static String getSign(Object o, String key) throws IllegalAccessException {
		...
		for (Field f : fields) {
			...
			if (f.get(o) != null && f.get(o) != "") {
				if(!(f.get(o) instanceof Logger || f.get(o) instanceof KPFSSEServiceUnit)) {
	...
	/*public static Map<String,Object> getMapFromXML(String xmlString) throws ParserConfigurationException, IOException, SAXException {
        ...
        InputStream is =  Security.getStringStream(xmlString);
