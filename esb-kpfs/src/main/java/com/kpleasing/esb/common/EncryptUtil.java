...
public class EncryptUtil {
	private static final String KEY = "62313412";   // 8位
	...
	public static String decrypt(String str) throws Exception {
		return decrypt(KEY, str, IV);
	}
	
	public static void main(String args[]) {
		try {
			String mobile = "12312321312";  // 明文
			System.out.println("加密: " + encrypt(mobile));
			System.out.print("解密: " + decrypt(encrypt(mobile)));
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
