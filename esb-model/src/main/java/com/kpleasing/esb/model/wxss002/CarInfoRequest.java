...
public class CarInfoRequest extends RequestHeader implements Serializable {

	/** *  */
	private static final long serialVersionUID = -59556894861027091L;
	...
	private List<CarParam> car_params;
	...
	public List<CarParam> getCar_params() {
		return car_params;
	}

	public void setCar_params(List<CarParam> car_params) {
