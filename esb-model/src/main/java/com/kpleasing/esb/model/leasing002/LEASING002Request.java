...
public class LEASING002Request extends RequestHeader implements Serializable {

	/** * */
	private static final long serialVersionUID = -4261756723754670707L;
	...
	private List<LEASING002AttachmentInfo> attachs;
	...
	public List<LEASING002ContactInfo> getContacts() {
		return contacts;
	}

	public void setContacts(List<LEASING002ContactInfo> contacts) {
		this.contacts = contacts;
	}

	public List<LEASING002AccountInfo> getAccounts() {
		return accounts;
	}

	public void setAccounts(List<LEASING002AccountInfo> accounts) {
		this.accounts = accounts;
	}

	public List<LEASING002AttachmentInfo> getAttachs() {
		return attachs;
	}

	public void setAttachs(List<LEASING002AttachmentInfo> attachs) {
