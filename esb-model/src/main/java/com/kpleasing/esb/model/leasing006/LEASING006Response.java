...
public class LEASING006Response extends ResponseHeader implements Serializable {

	/**	 * 	 */
	private static final long serialVersionUID = 831562700433508192L;
	...
	private List<LEASING006Repay> repays;
	...
	public List<LEASING006Repay> getRepays() {
		return repays;
	}

	public void setRepays(List<LEASING006Repay> repays) {
		this.repays = repays;
	}
}